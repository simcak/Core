...
/*   Updated: 2024/12/18 11:30:59 by psimcak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 */
static void	get_measurements(t_map *map)
{
	int	max_width;
	int	line_num;
	int	line_len;
	...
	{
		line_len = last_char_index(map->grid[line_num]) + 1;
