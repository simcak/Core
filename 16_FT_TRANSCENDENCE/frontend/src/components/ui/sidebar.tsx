    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          side === 'left'
            ? 'left-0 h-svh group-data-[collapsible=offcanvas]:left-[calc(var(--sidebar-width)*-1)]'
            : 'right-0 top-[60px] group-data-[collapsible=offcanvas]:right-[calc(var(--sidebar-width)*-1)]',
          side === 'right' && 'h-[calc(100vh-60px)]',
