...
{\Large Petr {\textsc{\v{S}im\v{c}\'ak}}} \normalsize

\null\hfill\includegraphics[width=0.8\textwidth]{me.jpg}\hfill\null
...
\headleft{Contact}
\small
\Letter\ \href{mailto:peta.simcak@gmail.com}{peta.simcak@gmail.com} \\[0.4ex]
\Mobilefone\ +420\,601\,381\,619 \\[0.4ex]
\Mundus\ \href{https://simcak.github.io}{simcak.github.io} \\[0.4ex]
\faMapMarker*\ Prague, Czech Republic \\[0.4ex]
...
\begin{itemize}
\item C, C++, Python, Bash, MATLAB, Typescript, SQL
\item Git, Docker, Linux, Nginx, LaTeX
\item Systems programming, networking
...
Hitchhiker at 42Prague \\[0.4ex]
3D printer assembly, maintenance, and support \\[0.4ex]
C++ exam board support
\normalsize
...
\smaller{Team-based web application developed at 42. Audiobook marketplace with audio streaming, built with FastAPI, React, Docker, and PostgreSQL.}
...
\is
\dates{2023--2025} \\
\textsc{Additional 42 projects} \textit{(C, C++, Docker)} \\
\smaller{Completed minishell, Inception and other projects; gained experience with Unix processes, shell logic, containerization, and deployment setup.}

\headright{Education}

\dates{2023--2026} \\
\textsc{42Prague} \textit{(with period at 42Heilbronn, 2024--2025)} \\
...
\is
\dates{2026--present} \\
\textsc{Hitchhiker at 42Prague} \\
\smaller{Representing the school values and culture, supporting new students, and helping with school events.}
...
\smaller{Assembled a 3D printer at BUT and later maintained and supported its operation at 42Prague.}

\is
\dates{2013--2021} \\
\textsc{Movie Actor} \textit{({\hypersetup{urlcolor=black}\href{https://www.imdb.com/name/nm5791331/}{IMDb}})} \\
\smaller{Worked in long-term collaborative productions in demanding environments.}

\is
\dates{2009--2015} \\
\textsc{Theatre Actor} \textit{({\hypersetup{urlcolor=black}\href{https://www.mdb.cz/cs/lide/petr-simcak}{Brno City Theatre}})} \\
