...
/*   Updated: 2024/08/01 07:00:16 by psimcak          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void PhoneBook::initContact(std::string data[4])
{
	...
	safeGetline(data[0], "First Name: ");
	safeGetline(data[1], "Last Name: ");
	safeGetline(data[2], "Nickname: ");
	safeGetline(data[3], "Phone Number: ");
	safeGetline(data[4], "Darkest Secret: ");
}
...
void PhoneBook::addContact(std::string data[4])
{
	...
	if (this->contact_id < 8)
		this->contact_id++;

	std::cout << GRN << "✅ Contact [" << id << "] added" << RST << std::endl;
}
...
void	PhoneBook::searchContact( void )
{
	...
	safeGetline(input_index, "Enter index of the contact you want to see: ");
	i = input_index[0] - '0';
